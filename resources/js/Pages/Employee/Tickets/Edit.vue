...
export default defineComponent({
  ...
  setup(props) {
    ...
    const submit = () => {
      form.put(route('employee.tickets.update', props.ticket.id));
    };
