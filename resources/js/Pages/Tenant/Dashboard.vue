          ...
          <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
            ...
            <div class="mt-12">
              <div class="flex justify-between items-center mb-4">
                ...
                <Link :href="route('tenant.tickets.create')" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                  New Ticket
                </Link>
              </div>
              ...
              <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <ul class="divide-y divide-gray-200">
                  <li v-for="ticket in recentTickets" :key="ticket.id">
                    <Link :href="route('tenant.tickets.show', ticket.id)" class="block hover:bg-gray-50">
